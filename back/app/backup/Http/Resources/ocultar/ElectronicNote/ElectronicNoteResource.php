...
class ElectronicNoteResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            "ce_relation" => $this->resource->ce_relation ? [
                "id" => $this->resource->ce_relation->id,
                 "n_operacion" => $this->resource->ce_relation->n_operacion,
                 "subtotal" => (float) $this->resource->ce_relation->subtotal,
                 "total" => (float) $this->resource->ce_relation->total,
                 "igv" => (float) $this->resource->ce_relation->igv,
             ]: NULL,
            "cdr" => env("APP_URL_2").$this->resource->cdr,
            "xml" => env("APP_URL_2").$this->resource->xml,
            "igv_discount_general" => (float) $this->resource->igv_discount_general,
            // 
