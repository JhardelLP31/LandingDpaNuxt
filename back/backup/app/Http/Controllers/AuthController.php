...
class AuthController extends Controller
{
    ...
    {
        // Nota: Asegúrate que auth('api')->user() no sea null aquí.
        // Al hacer auth()->login($user) arriba, ya debería estar seteado.

        $user = auth('api')->user(); // Obtenemos el usuario logueado
        ...
        return response()->json([
            ...
            "user" => [
                ...
                "email" => $user->email,
                // Validamos avatar null
                "avatar" => $user->avatar ? env("APP_URL") . "storage/" . $user->avatar : null,
                "role" => [
                    // Validamos que role no sea null para evitar crash
