...
.portal-container {
  padding: 80px 24px;
  max-width: 1300px; // Un poco más ajustado para que 3 luzcan mejor
  width: 100%;
  margin: 0 auto;
}
...
.section-header {
  ...
  align-items: flex-start; // Mantiene tu alineación a la izquierda
...
.portal-grid {
  display: grid;
  // FUERZA 3 POR FILA, pero con un máximo de ancho para que no sean "waaa"
  grid-template-columns: repeat(3, minmax(0, 300px)); 
  justify-content: space-between; // Separa las tarjetas equitativamente
  gap: 40px;
