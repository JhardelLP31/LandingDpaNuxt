...
const submitForm = async () => {
  ...
  try {
    // ✅ CAPTURA DEL SLUG DESDE LA URL (ej: 'ingenieria-de-sistemas-dpa')
    ...
    const payloadForDB = {
      ...
      // Enviamos el slug en la raíz por si tu backend lo espera como un campo directo
      ...
      payload: {
        ...
        // Lo incluimos también dentro del JSON 'payload' por si tu Laravel lo guarda allí
