...
const localData = ref({
  // --- Colores ---
  bgColor: props.modelValue?.bgColor || '#fcf5fb', // Un tono muy suave, como el bg-plum-50
  textColor: props.modelValue?.textColor || '#1e293b', // slate-800
  accentColor: props.modelValue?.accentColor || '#8c357f', // El morado plum
  
  // --- Parte 1: Desarrollo Profesional ---
...
// --- Lógica Tarjetas (Especialización) ---
...
// Galería rápida de iconos para las tarjetas
