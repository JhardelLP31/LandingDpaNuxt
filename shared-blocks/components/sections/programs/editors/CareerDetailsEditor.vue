...
const localData = ref({
  ...
  // CAMBIO 1: Valores por defecto usando Bootstrap Icons
...
// --- LÓGICA DE ITEMS ---
const addItem = () => {
  // Cuando agregas uno nuevo, usa un ícono de Bootstrap por defecto
...
// CAMBIO 2: Galería adaptada a Bootstrap Icons (Idóneos para ESAN/Universidades)
...
const selectIcon = (iconClass: string) => {
  if (activeIconIndex.value !== null) {
    ...
    activeIconIndex.value = null; // Cerramos la galería
  }
};
</script>
