...
const localData = ref({
  // Colores
  bgColor: props.modelValue?.bgColor || '#151e2d', // El azul oscuro de la imagen
  textColor: props.modelValue?.textColor || '#e2e8f0', // Texto claro
  iconHoverColor: props.modelValue?.iconHoverColor || '#8c357f', // Morado al hacer hover
  ...
  // Redes Sociales (URLs vacías ocultan el icono)
  socialLinks: {
