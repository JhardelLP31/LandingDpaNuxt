...
// Extrae el ID del video de YouTube y crea el link de "embed"
...
// Convierte el HEX del color a un rgba para la capa transparente
const overlayStyle = computed(() => {
  // Conversión básica de hex a rgba simulada con CSS nativo si es posible, 
  // pero lo más fácil es usar background-color nativo con opacity en la capa.
  return {
