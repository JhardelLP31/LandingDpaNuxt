...
// Helper para evitar que la app se rompa si la imagen falla
...
interface CareerData {
  ...
  // 1. REEMPLAZAMOS campaign_id POR EL OBJETO COMPLETO
  form_config?: any; 
}
...
const safeData = computed(() => {
  ...
  // 2. PARSEAMOS EL FORM CONFIG (por si el backend lo devuelve como string)
  ...
  return {
    ...
    // 3. ARMAMOS EL OBJETO CON VALORES POR DEFECTO POR SI ACASO
    form_config: {
