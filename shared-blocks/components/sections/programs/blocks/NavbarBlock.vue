...
// Referencias para calcular la altura y hacer el "contenedor fantasma"
...
// Calculamos la altura del Navbar una vez que se monta en la pantalla
...
onMounted(() => {
  ...
  // nextTick asegura que el DOM ya cargó para calcular la altura correcta
  nextTick(() => {
    calculateHeight();
    // Escuchamos si cambia el tamaño de la pantalla para recalcular la altura
