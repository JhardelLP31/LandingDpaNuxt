...
// Computed para inyectar dinámicamente el fondo de la sección

// 2. Esta función computada arma el objeto de estilo CSS final
const sectionStyle = computed(() => {
  // SI EL USUARIO ELIGIÓ "IMAGEN" Y HAY UNA URL VÁLIDA:
  ...
  // SI EL USUARIO ELIGIÓ "DEGRADADO":
  ...
  // POR DEFECTO (O SI ELIGIÓ "COLOR SÓLIDO"):
  return {
