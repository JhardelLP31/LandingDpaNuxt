...
// 1. Inicializamos el estado local con los textos de ESAN por defecto
const localData = ref({
  bgColor: props.modelValue?.bgColor || '#151515', // Casi negro
  textColor: props.modelValue?.textColor || '#a3a3a3', // Gris claro
...
// 2. Sincronizar de AFUERA hacia ADENTRO (escudo contra bucles)
...
// 3. Sincronizar de ADENTRO hacia AFUERA
