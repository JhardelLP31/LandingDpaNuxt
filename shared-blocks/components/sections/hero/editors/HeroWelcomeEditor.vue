...
// 1. Sincronizar de AFUERA hacia ADENTRO (con escudo contra bucles)
watch(() => props.modelValue, (newVal) => {
  if (!newVal) return;
  
  // SOLO actualizamos si el JSON es diferente (esto rompe la recursión)
...
// 2. Sincronizar de ADENTRO hacia AFUERA
