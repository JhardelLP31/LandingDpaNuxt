...
// Local state of the card
const localData = ref({
  color: props.modelValue?.color || '#00A89E', // Default Teal/Cyan color from image_10.png
  image: props.modelValue?.image || 'https://ue.edu.pe/pregrado/images/dpa/carreras/administracion.png', // Provided HTML student
