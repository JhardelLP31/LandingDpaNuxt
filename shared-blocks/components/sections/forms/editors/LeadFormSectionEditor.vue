...
// 1. IMPORTAMOS TU COMPONENTE ORIGINAL DEL EDITOR DEL FORMULARIO
import FormEditor from './FormEditor.vue';

const props = defineProps<{ modelValue: any }>();
const emit = defineEmits(['update:modelValue', 'select-image']);

// ESTADO UNIFICADO: Diseño de Marketing + Configuración del Formulario
const localData = ref({
  // 1. Diseño y Fondo
  ...
  themeColor: props.modelValue?.themeColor || '#a00000', // Color del Botón (Guinda por defecto)
  linkColor: props.modelValue?.linkColor || '#ff2b2b',   // Color del Link (Rojo por defecto)
  
  // 2. Textos Visibles en el Hero
  ...
  marketingImage: props.modelValue?.marketingImage || '', // Arranca vacío para que no se muestre por defecto

  // 4. Configuración del Formulario Interno
...
// Función para limpiar/eliminar la imagen extra
