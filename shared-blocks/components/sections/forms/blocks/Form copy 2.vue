...
import { useReCaptcha } from 'vue-recaptcha-v3'; // <-- Importamos el composable
...
const payloadForDB = {
    ...
    /*formData.value = {
      ...
      acepta_condiciones: false, acepta_publicidad: false, condition:'https://www.ue.edu.pe/pregrado/politica-de-privacidad', cod_form_old: 0
    };*/
