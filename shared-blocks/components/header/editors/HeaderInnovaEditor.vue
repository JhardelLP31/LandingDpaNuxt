...
// Proxy de solo lectura (evita mutaciones directas peligrosas)
const localContent = computed(() => props.modelValue || {});

// --- FUNCIONES CENTRALIZADAS DE ACTUALIZACIÓN ---

// Actualiza campos simples (strings, colores)
const updateField = (field: string, value: string) => {
    emit('update:modelValue', { ...props.modelValue, [field]: value });
};

// Actualiza campos dentro de un array (ej: topLinks[0].label)
