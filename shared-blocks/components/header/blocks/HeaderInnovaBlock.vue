...
// --- 1. DEFINICIÓN DE LA INTERFAZ Y EL PROP 'data' ---
...
// --- 2. COMPUTED PARA MANEJAR VALORES POR DEFECTO ---
...
// 1. Prioridad: Editor Global > Configuración del Bloque
...
// 2. Variables de diseño estáticas o de bloque
...
.app-header {
  position: relative;
  width: 100%;
  font-family: $fuente-principal; // Aplicación de la fuente elegida
}
...
.bannerBloque {
  ...
  .menuBloque {
    ...
    &--fijo {
      ...
      border-bottom: 2px solid $color-primario; // Borde dinámico
  ...
  .menuPrincipal {
    &__n1 {
      ...
      a {
        ...
        &:hover { color: $color-primario; } // Color dinámico en hover
      }
    }
  }
