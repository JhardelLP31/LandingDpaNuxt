import { a as onKeyStroke, o as unrefElement, s as useBreakpoints, t as breakpointsBootstrapV5 } from "./dist-Dk9C_HFS.mjs";
...
import { t as getElement } from "./getElement-D2Jr1cbp.mjs";
import { n as useActivatedFocusTrap, t as useSafeScrollLock } from "./useSafeScrollLock-Me5LyqjD.mjs";
...
var BOffcanvas_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const showBackdrop = computed(() => (props.responsive === void 0 || !isOpenByBreakpoint.value) && !props.noBackdrop && (showRef.value === true || isLeaving.value && props.backdropFirst && !computedNoAnimation.value));
...
//# sourceMappingURL=BOffcanvas-DaKJOICF.mjs.map