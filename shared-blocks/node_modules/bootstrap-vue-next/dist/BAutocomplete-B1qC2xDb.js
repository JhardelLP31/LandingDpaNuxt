...
const require_PopperContent = require("./PopperContent-BS_eKjzD.js");
const require_useKbd = require("./useKbd-sqDCJtXL.js");
...
const require_useFormSelect = require("./useFormSelect-CjAziZpu.js");
let vue = require("vue");
...
var BAutocomplete_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const emit = __emit;
		const _input = (0, vue.useTemplateRef)("_input");
		...
		const computedId = require_useId.useId(() => props.id, "autocomplete");
		const { normalizedOptions } = require_useFormSelect.useFormSelect(() => props.options, props);
		const singleSelectedLabelCache = (0, vue.ref)(null);
		...
		const showClearButton = (0, vue.computed)(() => !props.required && !props.noClearButton && !props.disabled && !props.readonly && hasSelection.value);
		...
		const comboboxInputProps = (0, vue.computed)(() => ({
			"id": computedId.value,
		...
		__expose({
			...
			element: (0, vue.computed)(() => _input.value?.element?.value ?? null),
				...
				default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(ComboboxAnchor_default), { "as-child": "" }, {
					default: (0, vue.withCtx)(() => [(0, vue.createVNode)(require_BInputGroup.BInputGroup_default, { size: (0, vue.unref)(props).size }, {
						append: (0, vue.withCtx)(() => [!(0, vue.unref)(props).noToggle ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(ComboboxTrigger_default), {
							...
							default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "toggle", {
								isOpen: isOpen.value,
								disabled: (0, vue.unref)(props).disabled
								...
								}, [..._cache[3] || (_cache[3] = [(0, vue.createElementVNode)("path", {
									"fill-rule": "evenodd",
						...
						default: (0, vue.withCtx)(() => [(0, vue.unref)(props).multiple && hasSelection.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
						...
						}), 128))], 2)) : (0, vue.createCommentVNode)("", true), (0, vue.createElementVNode)("div", _hoisted_2, [(0, vue.createVNode)((0, vue.unref)(ComboboxInput_default), {
							modelValue: searchTerm.value,
							"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => searchTerm.value = $event),
							"as-child": "",
							"display-value": displayValueFn
						}, {
							default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "input", (0, vue.mergeProps)(comboboxInputProps.value, { searchTerm: searchTerm.value }), () => [(0, vue.createVNode)(require_BFormInput.BFormInput_default, (0, vue.mergeProps)({
								ref_key: "_input",
								ref: _input,
							...
							_: 3
						}, 8, ["modelValue"]), showClearButton.value ? ((0, vue.openBlock)(), (0, vue.createBlock)(require_BCloseButton.BCloseButton_default, {
							key: 0,
							class: "b-autocomplete-clear",
							"aria-label": "Clear selected value",
							onClick: (0, vue.withModifiers)(clearSelection, ["stop"])
					...
					default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(ComboboxContent_default), {
						...
						default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(ComboboxViewport_default), { class: "b-autocomplete-viewport" }, {
							default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(ComboboxEmpty_default), { class: "b-autocomplete-empty" }, {
								default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "empty", {}, () => [_cache[4] || (_cache[4] = (0, vue.createTextVNode)(" No results found ", -1))])]),
								_: 3
								...
								return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(ComboboxItem_default), {
									...
									default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "option", (0, vue.mergeProps)({ ref_for: true }, option), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)(option.text), 1)]), (0, vue.createVNode)((0, vue.unref)(ComboboxItemIndicator_default), { class: "b-autocomplete-item-indicator" }, {
										default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "option-indicator", {}, () => [_cache[5] || (_cache[5] = (0, vue.createElementVNode)("svg", {
											xmlns: "http://www.w3.org/2000/svg",
											width: "16",
											height: "16",
											fill: "currentColor",
...
//# sourceMappingURL=BAutocomplete-B1qC2xDb.js.map