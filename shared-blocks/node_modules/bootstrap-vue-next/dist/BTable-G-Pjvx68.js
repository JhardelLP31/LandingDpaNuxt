...
const require_stringUtils = require("./stringUtils-68ZN_GRt.js");
const require_debounce = require("./debounce-D6kifS6w.js");
...
var BTable_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		const props = require_useDefaults.useDefaults(__props, "BTable");
		const emit = __emit;
		const slots = (0, vue.useSlots)();
		const dynamicCellSlots = (0, vue.computed)(() => Object.keys(slots).filter((key) => key.startsWith("cell(")));
		const dynamicFootSlots = (0, vue.computed)(() => Object.keys(slots).filter((key) => key.startsWith("foot(")));
		const sortByModel = (0, vue.useModel)(__props, "sortBy");
		const busyModel = (0, vue.useModel)(__props, "busy");
		const selectedItemsModel = (0, vue.useModel)(__props, "selectedItems");
		const expandedItems = (0, vue.useModel)(__props, "expandedItems");
		const itemsModel = (0, vue.useModel)(__props, "items");
		const currentPage = (0, vue.useModel)(__props, "currentPage");
		const computedId = require_useId.useId(() => props.id);
		const perPageNumber = require_dist.useToNumber(() => props.perPage, { method: "parseInt" });
		...
		const currentPageNumber = require_dist.useToNumber(currentPage, { method: "parseInt" });
		const writableCurrentPageNumber = (0, vue.computed)({
		...
		const providerController = useTableProvider({
			...
			busy: busyModel,
			provider: (0, vue.toRef)(() => props.provider),
			debounce: {
				maxWait: debounceMaxWaitNumber,
				wait: debounceNumber
			},
			currentPage: (0, vue.readonly)(writableCurrentPageNumber),
		...
		const { items: computedItems, displayItems: computedDisplayItems, getStringValue, fields: computedFields, isFilterableTable } = useTableMapper({
			fields: () => props.fields,
			provider: {
				noProviderFiltering: () => props.noProviderFiltering,
				noProviderPaging: () => props.noProviderPaging,
			...
			pagination: {
				...
				filter: {
					filter: () => props.filter,
					filterFunction: (0, vue.toRef)(() => props.filterFunction),
		...
		const tableClasses = (0, vue.computed)(() => ({
			"b-table-busy": busyModel.value,
			"b-table-selectable": props.selectable,
			"user-select-none": props.selectable && !props.noSelectOnClick && selectedItemsController.isActivated.value,
			"b-table-fixed": props.fixed,
			"b-table-no-border-collapse": props.noBorderCollapse,
			"b-table-no-sort-icon": props.noSortableIcon
		}));
		const getBusyRowClasses = (0, vue.computed)(() => [props.tbodyTrClass ? typeof props.tbodyTrClass === "function" ? props.tbodyTrClass(null, "table-busy") : props.tbodyTrClass : null]);
		const getFieldColumnClasses = (field) => [{ "b-table-sortable-column": sortController.isSortable.value && field.sortable }];
		const getRowClasses = (item, type) => [{ [`selected table-${props.selectionVariant}`]: props.selectable && !!item && selectedItemsController.has(item) }, props.tbodyTrClass ? typeof props.tbodyTrClass === "function" ? props.tbodyTrClass(item, type) : props.tbodyTrClass : null];
		...
		const emptySlotScope = (0, vue.computed)(() => ({
		...
		__expose({
			...
			selection: {
				...
				selectedItems: (0, vue.readonly)(selectedItemsModel)
			},
			items: computedItems,
			displayItems: computedDisplayItems,
			getStringValue,
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)(BTableLite_default, (0, vue.mergeProps)(computedLiteProps.value, {
				"expanded-items": expandedItems.value,
				"onUpdate:expandedItems": _cache[0] || (_cache[0] = ($event) => expandedItems.value = $event)
			}), (0, vue.createSlots)({
				"custom-body": (0, vue.withCtx)((scope) => [busyModel.value && slots["table-busy"] ? ((0, vue.openBlock)(), (0, vue.createBlock)(BTr_default, {
					key: 0,
					class: (0, vue.normalizeClass)(["b-table-busy-slot", getBusyRowClasses.value])
				}, {
					default: (0, vue.withCtx)(() => [(0, vue.createVNode)(BTd_default, { colspan: scope.fields.length }, {
						default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "table-busy")]),
						_: 3
					}, 8, ["colspan"])]),
					_: 2
				}, 1032, ["class"])) : !busyModel.value && (0, vue.unref)(props).showEmpty === true && (0, vue.unref)(computedItems).length === 0 ? ((0, vue.openBlock)(), (0, vue.createBlock)(BTr_default, {
					key: 1,
					class: "b-table-empty-row"
				}, {
					default: (0, vue.withCtx)(() => [(0, vue.createVNode)(BTd_default, { colspan: (0, vue.unref)(computedFields).length }, {
						default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", _hoisted_1, [(0, vue.createElementVNode)("div", _hoisted_2, [showEmptyFiltered.value ? (0, vue.renderSlot)(_ctx.$slots, "empty-filtered", (0, vue.normalizeProps)((0, vue.mergeProps)({ key: 0 }, emptySlotScope.value)), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)((0, vue.unref)(props).emptyFilteredText), 1)]) : (0, vue.renderSlot)(_ctx.$slots, "empty", (0, vue.normalizeProps)((0, vue.mergeProps)({ key: 1 }, emptySlotScope.value)), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)((0, vue.unref)(props).emptyText), 1)])])])]),
						_: 3
					}, 8, ["colspan"])]),
					_: 3
				})) : (0, vue.createCommentVNode)("", true)]),
				...
				slots["table-colgroup"] ? {
					name: "table-colgroup",
					fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, "table-colgroup", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(scope)))]),
					key: "0"
				} : void 0,
				slots["thead-top"] ? {
					name: "thead-top",
					fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, "thead-top", (0, vue.mergeProps)(scope, {
				...
				slots["thead-sub"] ? {
					name: "thead-sub",
					fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, "thead-sub", (0, vue.mergeProps)(scope, { fields: (0, vue.unref)(computedFields) }))]),
					key: "2"
				} : void 0,
				slots["top-row"] ? {
					name: "top-row",
					fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, "top-row", (0, vue.mergeProps)(scope, { fields: (0, vue.unref)(computedFields) }))]),
					key: "3"
				} : void 0,
				slots["row-expansion"] ? {
					name: "row-expansion",
					fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, "row-expansion", (0, vue.mergeProps)(scope, {
						fields: (0, vue.unref)(computedFields),
						selectRow: () => (0, vue.unref)(selectedItemsController).add(scope.item),
						unselectRow: () => (0, vue.unref)(selectedItemsController).remove(scope.item),
						rowSelected: (0, vue.unref)(selectedItemsController).has(scope.item)
					}))]),
					key: "4"
				} : void 0,
				slots["bottom-row"] ? {
					name: "bottom-row",
					fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, "bottom-row", (0, vue.mergeProps)(scope, { fields: (0, vue.unref)(computedFields) }))]),
					key: "5"
				} : void 0,
				slots["custom-foot"] ? {
					name: "custom-foot",
					fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, "custom-foot", (0, vue.mergeProps)(scope, { fields: (0, vue.unref)(computedFields) }))]),
					key: "6"
				} : void 0,
				slots["table-caption"] ? {
					name: "table-caption",
					fn: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "table-caption")]),
					key: "7"
				} : void 0,
				(0, vue.renderList)(dynamicCellSlots.value, (name) => {
					return {
						name,
						fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, name, (0, vue.mergeProps)(scope, {
							selectRow: () => (0, vue.unref)(selectedItemsController).add(scope.item),
							unselectRow: () => (0, vue.unref)(selectedItemsController).remove(scope.item),
							rowSelected: (0, vue.unref)(selectedItemsController).has(scope.item)
						}))])
				...
				(0, vue.renderList)(dynamicFootSlots.value, (name) => {
					return {
						name,
						fn: (0, vue.withCtx)((scope) => [(0, vue.renderSlot)(_ctx.$slots, name, (0, vue.mergeProps)(scope, {
							selectAllRows: (0, vue.unref)(selectedItemsController).setAll,
				...
				(0, vue.renderList)((0, vue.unref)(computedFields), (field) => {
					return {
...
//#endregion
Object.defineProperty(exports, "BTableLite_default", {
	enumerable: true,
	get: function() {
		return BTableLite_default;
	}
});
Object.defineProperty(exports, "BTable_default", {
	enumerable: true,
	get: function() {
		return BTable_default;
	}
});
Object.defineProperty(exports, "BTbody_default", {
	enumerable: true,
	get: function() {
		return BTbody_default;
	}
});
Object.defineProperty(exports, "BTd_default", {
	enumerable: true,
	get: function() {
		return BTd_default;
	}
});
Object.defineProperty(exports, "BTfoot_default", {
	enumerable: true,
	get: function() {
		return BTfoot_default;
	}
});
Object.defineProperty(exports, "BTh_default", {
	enumerable: true,
	get: function() {
		return BTh_default;
	}
});
Object.defineProperty(exports, "BThead_default", {
	enumerable: true,
	get: function() {
		return BThead_default;
	}
});
Object.defineProperty(exports, "BTr_default", {
	enumerable: true,
	get: function() {
		return BTr_default;
	}
...
//# sourceMappingURL=BTable-G-Pjvx68.js.map