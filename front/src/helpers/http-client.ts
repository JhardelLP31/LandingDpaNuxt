...
axiosInstance.interceptors.response.use(
    ...
    (error) => {
        ...
        // 2. Clasificación de errores según el código HTTP
        switch (status) {
            case 422: // Errores de Validación (FormRequests de Laravel)
