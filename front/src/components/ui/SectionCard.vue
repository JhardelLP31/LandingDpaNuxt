...
.sector-card-wrapper {
  perspective: 1000px; // Preparar para efectos 3D si se desea
}
...
.sector-image {
  width: 100%;
  height: 100%;
  object-fit: contain; // Mantiene el logo/imagen sin recortar
  padding: 2.5rem; // Espacio para que el logo "respire"
  transition: all 0.6s ease;
  filter: grayscale(20%); // Un toque sutil de elegancia
}
