  ...
  <div class="top-bar py-1">
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
      ...
      <div class="logo-wrapper">
        <img src="@/assets/images/LogoHorizontal.png" alt="ESAN" class="img-fluid main-logo filter-white " />
      </div>
      ...
      <div class="d-flex flex-column flex-md-row align-items-center gap-3 w-100 justify-content-center px-md-5">
        <div class="social-icons d-flex gap-3 text-muted fs-5">
          <a href="https://www.facebook.com/CDE.ESAN/" class="social-link" target="_blank"><i class="fab fa-facebook-f"></i></a>
          <a href="https://x.com/esanperu" class="social-link" target="_blank"><i class="fab fa-twitter"></i></a>
          <a href="https://www.linkedin.com/company/cde-esan/" class="social-link" target="_blank"><i class="fab fa-linkedin-in"></i></a>
          <a href="https://www.instagram.com/cde_esan/" class="social-link" target="_blank"><i class="fab fa-instagram"></i></a>
          <a href="https://www.youtube.com/@cde-universidadesan866" class="social-link" target="_blank"><i class="fab fa-youtube"></i></a>
        </div>
