      ...
      >
        ...
        >
          ...
          <li class="mx-3 welcome-text">
            <h3 class="mb-0 fw-bold text-truncate">Good Morning, {{useAuth.user ? useAuth.user.full_name : ''}}!</h3>
            ...
            <div class="dropdown-menu stop dropdown-menu-end dropdown-lg py-0">
              ...
              >
                <li class="nav-item">
                  ...
                  >
                    ...
                    <b-badge
                      :variant="null"
                      class="bg-primary-subtle text-primary badge-pill ms-1"
                      >24</b-badge
                    >
                  </a>
                </li>
                <li class="nav-item">
                  <a
                    class="nav-link mx-0"
                    :class="show === 'projects-tab' && 'active'"
                    href="#Projects"
                    @click="show = 'projects-tab'"
                  >
                    Projects
                  </a>
                </li>
                <li class="nav-item">
                  <a
                    class="nav-link mx-0"
                    :class="show === 'teams-tab' && 'active'"
                    href="#Teams"
                    @click="show = 'teams-tab'"
                  >
                    Team
                  </a>
                </li>
              ...
              <simplebar class="ms-0" style="max-height: 230px" data-simplebar>
                <div class="tab-content" id="myTabContent">
                  <div
                    class="tab-pane fade"
                    :class="show === 'all-tab' && 'show active'"
                    id="All"
                  >
                  ...
                  <div
                    class="tab-pane fade"
                    :class="show === 'projects-tab' && 'show active'"
                    id="Projects"
                  >
                    <a href="#" class="dropdown-item py-3">
                      <small class="float-end text-muted ps-2"
                  ...
                  <div
                    class="tab-pane fade"
                    :class="show === 'teams-tab' && 'show active'"
                    id="Teams"
                  >
                    <a href="#" class="dropdown-item py-3">
                      <small class="float-end text-muted ps-2">1 hr ago</small>
            ...
            <div class="dropdown-menu dropdown-menu-end py-0">
              ...
              >
                ...
                <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                  <h6 class="my-0 fw-medium text-dark fs-13">{{useAuth.user ? useAuth.user.full_name : ''}}</h6>
